(function() {
  ...
  var matchMediaApp = angular.module('matchMedia', []);

  matchMediaApp.run(function initializeNgMatchMedia() {
  ...
  matchMediaApp.service('screenSize', ["$rootScope", function screenSize($rootScope) {
  ...
  matchMediaApp.filter('media', ['screenSize', function (screenSize) {
