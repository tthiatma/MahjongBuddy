...
namespace MahjongBuddy
{
    public static class TileBuilder
    {
        public static List<Tile> BuildWinningAllStraightTilesWithOneFlower()
        {
            ...
            tiles.Add(new Tile() { Type = TileType.Round, Status = TileStatus.UserGraveyard, Value = TileValue.One, Owner = "p1", Name = "1RoundOne", Image = "/Content/images/tiles/64px/pin/pin1.png" });
            tiles.Add(new Tile() { Type = TileType.Round, Status = TileStatus.UserGraveyard, Value = TileValue.Two, Owner = "p1", Name = "1RoundTwo", Image = "/Content/images/tiles/64px/pin/pin2.png" });
            tiles.Add(new Tile() { Type = TileType.Round, Status = TileStatus.UserGraveyard, Value = TileValue.Three, Owner = "p1", Name = "1RoundThree", Image = "/Content/images/tiles/64px/pin/pin3.png" });
