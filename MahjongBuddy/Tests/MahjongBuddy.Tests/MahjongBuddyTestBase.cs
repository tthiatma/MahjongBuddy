...
{
    public abstract class MahjongBuddyTestBase : AbpIntegratedTestBase
    {
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<MahjongBuddyApplicationModule>();
            modules.Add<MahjongBuddyDataModule>();
        }

        public void UsingDbContext(Action<MahjongBuddyDbContext> action)
        {
        ...
        public T UsingDbContext<T>(Func<MahjongBuddyDbContext, T> func)
        {
            T result;
